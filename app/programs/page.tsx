...
function ProgramsPageFallback() {
  const programs = [
    ...
    },
    {
      ...
      sectionId: "gymnastiki-gia-ollous",
  ...
  return (
    <div className="min-h-screen">
      ...
      {programs.map((program, index) => (
        <section 
          key={program.id} 
          id={program.sectionId}
          className={`py-20 ${index % 2 === 0 ? "bg-white" : "bg-background"}`}
        >
