  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 py-20 md:py-32 relative z-10">
          <div className="max-w-2xl text-white animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl mb-8 leading-relaxed text-white/90">
              Ανακαλύψτε τη μαγεία της γυμναστικής στον σύλλογό μας.
            </p>
            <Button
              size="lg"
      ...
      <section className="py-20 bg-background fade-in-section opacity-0">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-4 text-balance">Τα Τμήματά μας</h2>
          <p className="text-center text-muted-foreground text-lg mb-12 max-w-2xl mx-auto">
            Προσφέρουμε προγράμματα για όλες τις ηλικίες και τα επίπεδα
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card
              className="border-2 hover:border-primary transition-all hover:shadow-2xl hover:-translate-y-2 duration-300 rounded-2xl overflow-hidden group animate-fade-in-up"
            ...
            >
              ...
              <CardContent className="p-6">
                <h3 className="text-2xl font-bold mb-3">Καλλιτεχνική</h3>
            ...
            <Card
              className="border-2 hover:border-secondary transition-all hover:shadow-2xl hover:-translate-y-2 duration-300 rounded-2xl overflow-hidden group animate-fade-in-up"
            ...
            >
              ...
              <CardContent className="p-6">
                <h3 className="text-2xl font-bold mb-3">Ρυθμική</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <Card
              className="border-2 hover:border-accent transition-all hover:shadow-2xl hover:-translate-y-2 duration-300 rounded-2xl overflow-hidden group animate-fade-in-up"
            ...
            >
              ...
              <CardContent className="p-6">
                <h3 className="text-2xl font-bold mb-3">Προαγωνιστικά</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            >
              ...
              <CardContent className="p-6">
                <h3 className="text-2xl font-bold mb-3">Παιδικά</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
      ...
      <section className="py-20 bg-white fade-in-section opacity-0">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-4 text-balance">Οι Στιγμές μας</h2>
          <p className="text-center text-muted-foreground text-lg mb-12 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="relative h-80 rounded-2xl overflow-hidden group cursor-pointer">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <div className="absolute bottom-6 left-6 text-white">
                  <h3 className="text-2xl font-bold mb-2">UV Παράσταση</h3>
            ...
            <div className="relative h-80 rounded-2xl overflow-hidden group cursor-pointer">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <div className="absolute bottom-6 left-6 text-white">
                  <h3 className="text-2xl font-bold mb-2">Ομαδική Παράσταση</h3>
            ...
            <div className="relative h-80 rounded-2xl overflow-hidden group cursor-pointer">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <div className="absolute bottom-6 left-6 text-white">
                  <h3 className="text-2xl font-bold mb-2">Νεαρές Αθλήτριες</h3>
      ...
      <section className="py-20 bg-background fade-in-section opacity-0">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold mb-2 text-balance">Νέα & Ανακοινώσεις</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="rounded-2xl overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              <div className="relative h-56 overflow-hidden group">
                <Image
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_6064-dtKNW2y3nWi4kjmvriBpP8rrQpz5wE.jpeg"
                  alt="Επιτυχημένη συμμετοχή σε αγώνες"
                  fill
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold mb-3 hover:text-primary transition-colors">
                  Επιτυχημένη Συμμετοχή στους Πανελλήνιους Αγώνες
                </h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Οι αθλήτριές μας διακρίθηκαν στους πρόσφατους αγώνες, κερδίζοντας 5 μετάλλια και κάνοντας υπερήφανο
                  τον σύλλογο.
                </p>
            ...
            <Card className="rounded-2xl overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-2 text-sm text-muted-foreground mb-3">
                  <Calendar className="h-4 w-4" />
                  <span>8 Ιανουαρίου 2025</span>
                </div>
                <h3 className="text-xl font-bold mb-3 hover:text-primary transition-colors">
                  Ανοίγουν Νέα Τμήματα για τη Σεζόν 2025
                </h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Ξεκινούν οι εγγραφές για τα νέα τμήματα! Προσφέρουμε δωρεάν δοκιμαστικό μάθημα για όλους τους νέους
                  αθλητές.
                </p>
                <Button variant="link" className="p-0 hover:translate-x-2 transition-transform" asChild>
                  <Link href="/news">
            ...
            <Card className="rounded-2xl overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-2 text-sm text-muted-foreground mb-3">
                  <Calendar className="h-4 w-4" />
                  <span>20 Δεκεμβρίου 2024</span>
                </div>
                <h3 className="text-xl font-bold mb-3 hover:text-primary transition-colors">
                  Μαγική Ετήσια Παράσταση 2024
                </h3>
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Η ετήσια παράστασή μας ήταν μια απόλυτη επιτυχία! Ευχαριστούμε όλους όσους μας τίμησαν με την παρουσία
                  τους.
                </p>
                <Button variant="link" className="p-0 hover:translate-x-2 transition-transform" asChild>
                  <Link href="/news">
      ...
      <section className="py-20 bg-white fade-in-section opacity-0">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-4 text-balance">Οι Υποστηρικτές μας</h2>
